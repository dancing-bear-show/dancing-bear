"""Tests for phone CLI inline command helpers and inline commands.

Tests the helper functions extracted from inline commands, and the commands
that perform inline operations (auto-folders, profile build, manifest create/build).
"""
...
class TestInlineCommandHelpers(unittest.TestCase):
    ...
    @patch("phone.cli.cmd_profile.Path")
    ...
    def test_extract_manifest_profile_config_loads_layout_when_path_present(self, mock_read):
        ...
        _plan, layout, _profile = _extract_manifest_profile_config(manifest)
...
class TestInlineCommands(unittest.TestCase):
    ...
    @patch("phone.cli.cmd_layout.load_layout")
    @patch("phone.cli.cmd_layout.read_yaml")
    @patch("phone.cli.cmd_layout.write_yaml")
    @patch("phone.cli.cmd_layout.auto_folderize")
    @patch("phone.cli.cmd_layout.distribute_folders_across_pages")
    ...
    @patch("phone.cli.cmd_profile.read_yaml")
    @patch("phone.cli.cmd_profile._build_manifest_dict")
    @patch("phone.cli.cmd_profile.write_yaml")
    ...
    @patch("phone.cli.cmd_profile.read_yaml")
    @patch("phone.cli.cmd_profile._extract_manifest_profile_config")
    ...
    def test_manifest_build_delegates_to_helper(self, mock_build, mock_extract, mock_read):
        ...
        with patch("plistlib.dump"), patch("phone.cli.cmd_profile.Path"):
...
class TestAutoFoldersCommand(unittest.TestCase):
    ...
    @patch("phone.cli.cmd_layout.load_layout")
    @patch("phone.cli.cmd_layout.Path")
    @patch("phone.cli.cmd_layout.read_yaml")
    @patch("phone.cli.cmd_layout.write_yaml")
    @patch("phone.cli.cmd_layout.auto_folderize")
    @patch("phone.cli.cmd_layout.distribute_folders_across_pages")
