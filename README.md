...
- Phone (iOS layout tooling): `./bin/phone` — reorganize your home screen: `./bin/phone-assistant reorg` (target device from `[ios_devices] default` in credentials.ini; see `src/phone/README.md`)
