...
class TestResumeSeparatorCLI(SeparatorContractMixin, unittest.TestCase):
    """The shared ``--`` separator contract."""

    MODULE_PATH = "resume.cli.main"
    APP_ID = "resume"



class TestResumeNoSubcommand(NoSubcommandContractMixin, unittest.TestCase):
