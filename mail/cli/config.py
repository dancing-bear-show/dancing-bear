...
_UNIFIED_FILTERS_HELP = "Unified filters YAML (filters: [])"
...
def register(subparsers, **handlers):
    ...
    p_cfg_derive_filters.add_argument("--in", dest="in_path", required=True, help=_UNIFIED_FILTERS_HELP)
    ...
    p_cfg_opt_filters.add_argument("--in", dest="in_path", required=True, help=_UNIFIED_FILTERS_HELP)
    ...
    p_cfg_audit_filters.add_argument("--in", dest="in_path", required=True, help=_UNIFIED_FILTERS_HELP)
