...
- Derive provider configs; do not hand-edit derived outputs (written to the `--out-*` paths you pass, or `core.paths.output_dir("mail")` — outside the checkout by default).
