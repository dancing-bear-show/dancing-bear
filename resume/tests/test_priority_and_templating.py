...
try:
    from resume.resume import experience_summary
    from resume.resume import priority
    from resume.resume import templating
except ModuleNotFoundError:
    from resume import experience_summary
    from resume import priority
    from resume import templating
