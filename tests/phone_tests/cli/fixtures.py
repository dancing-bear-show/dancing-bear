...
# Module-level constants for default paths and identifiers
DEFAULT_ICON_STATE_PATH = "out/ios.IconState.yaml"
DEFAULT_PLAN_PATH = "out/ios.plan.yaml"
DEFAULT_MANIFEST_PATH = "out/ios.manifest.yaml"
...
def make_export_args(
    ...
    out: str = DEFAULT_ICON_STATE_PATH,
) -> MagicMock:
...
def make_manifest_from_export_args(
    export: str = DEFAULT_ICON_STATE_PATH,
    out: str = "out/ios.manifest.from_export.yaml",
    label: Optional[str] = None,
    udid: Optional[str] = None,
    creds_profile: str = "ios_layout_manager",
    identifier: str = DEFAULT_PROFILE_IDENTIFIER,
    hs_identifier: str = DEFAULT_HS_IDENTIFIER,
...
def make_manifest_create_args(
    from_plan: str = DEFAULT_PLAN_PATH,
    out: str = DEFAULT_MANIFEST_PATH,
    label: Optional[str] = None,
    udid: Optional[str] = None,
    creds_profile: str = "ios_layout_manager",
    layout: Optional[str] = None,
