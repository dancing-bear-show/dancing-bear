...
from telemetry.otel.cost_models import AnomalyFlag, CostMetrics, SessionCost, SessionPerf
...
def _make_perf(avg_api_latency_ms: float = 100.0) -> SessionPerf:
    return SessionPerf(avg_api_latency_ms=avg_api_latency_ms)
