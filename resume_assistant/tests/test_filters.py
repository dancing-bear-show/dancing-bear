...
try:
    from resume_assistant.resume_assistant import experience_filter
    from resume_assistant.resume_assistant import skills_filter
except ModuleNotFoundError:
    from resume_assistant import experience_filter
    from resume_assistant import skills_filter
