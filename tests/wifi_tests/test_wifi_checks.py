"""Tests for wifi/diagnostics_probes.py and wifi/diagnostics_report.py — parse, check, format, and run functions."""
...
from wifi.diagnostics_runners import CommandResult
