...
# Default profile identifiers and display name
DEFAULT_PROFILE_ID = "com.example.profile"
DEFAULT_HS_ID = "com.example.hslayout"
...
@profile_group.argument("--identifier", default=DEFAULT_PROFILE_ID, help="Top-level PayloadIdentifier")
@profile_group.argument("--hs-identifier", default=DEFAULT_HS_ID, help="Home Screen PayloadIdentifier")
...
def cmd_profile_build(args) -> int:
    try:
        ...
        profile_dict = build_mobileconfig(
            ...
            top_identifier=getattr(args, "identifier", DEFAULT_PROFILE_ID),
            hs_identifier=getattr(args, "hs_identifier", DEFAULT_HS_ID),
...
def _build_manifest_dict(plan: dict, args) -> dict:
    ...
    manifest = {
        ...
        "profile": {
            "identifier": getattr(args, "identifier", DEFAULT_PROFILE_ID),
            "hs_identifier": getattr(args, "hs_identifier", DEFAULT_HS_ID),
            "display_name": getattr(args, "display_name", DEFAULT_DISPLAY_NAME),
...
@manifest_group.argument("--identifier", default=DEFAULT_PROFILE_ID, help="Profile identifier")
@manifest_group.argument("--hs-identifier", default=DEFAULT_HS_ID, help="Home Screen PayloadIdentifier")
...
def cmd_manifest_build(args) -> int:
    ...
    profile_dict = build_mobileconfig(
        plan=plan,
        layout_export=layout_export,
        top_identifier=prof.get("identifier", DEFAULT_PROFILE_ID),
        hs_identifier=prof.get("hs_identifier", DEFAULT_HS_ID),
