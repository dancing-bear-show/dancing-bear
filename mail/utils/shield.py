...
SECRET_VALUE_PATTERNS: list[re.Pattern[str]] = [
    ...
    re.compile(r"\bglsa_[A-Za-z0-9]{20,}\b"),  # Grafana service account token
    re.compile(r"\bxox[abpisr]-[A-Za-z0-9-]{10,}\b"),  # Slack tokens
    re.compile(r"\bapi-[A-Za-z0-9]{16,}\b"),  # API tokens like LaunchDarkly
    re.compile(r"\brootly_[A-Za-z0-9]{16,}\b"),  # Rootly
    re.compile(r"\bsk-(?:live|test|proj)-[A-Za-z0-9_-]{16,}\b"),  # OpenAI tokens
