...
| resume-copy.md | Resume/profile copy: bullet voice, quantification, banned phrases, LinkedIn limits | 15 |
| workflow-stages.md | Workflow stage runtime concerns, model tier, tool access | 13 |
