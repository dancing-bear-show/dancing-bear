...
Note: `./bin/llm agentic --stdout` inlines the first three of these. Use
`--compact` (2KB vs 38KB) unless you specifically want them preloaded.
...
There is no `.llm/DOMAIN_MAP.md` file — the domain map is generated by the command
above. Do not try to read it as a file.
