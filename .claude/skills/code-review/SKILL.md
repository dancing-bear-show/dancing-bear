...
| Global findings log | `tail -20 ~/.cache/claude/code-review-findings.ndjson \| python3 -I -S -m json.tool` |
...
```bash
# tail recent reviews
tail -5 ~/.cache/claude/code-review-findings.ndjson | python3 -I -S -m json.tool
