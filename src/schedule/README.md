...
- Plan to YAML (ephemeral):
  - `./bin/schedule plan --source schedules/fall.csv --out out/schedule.plan.yaml`
...
- Sync plan to Outlook (dry-run by default):
  - `./bin/schedule sync --plan out/schedule.plan.yaml --calendar "Your Family" --from 2025-10-01 --to 2025-12-31`
