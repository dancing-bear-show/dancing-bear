...
class MessagesHandlers:
    """Handler functions for messages subcommands."""
...
def register(subparsers, add_gmail_args, *, handlers: MessagesHandlers):
    ...
    p_msgs_search.set_defaults(func=handlers.f_search)
    ...
    p_msgs_reply.set_defaults(func=handlers.f_reply)
    ...
    p_msgs_apply.set_defaults(func=handlers.f_apply_scheduled)
