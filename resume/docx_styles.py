...
class StyleManager:
    ...
    def tight_paragraph(
        ...
        try:
            ...
            pass  # noqa: S110 - paragraph format failure
    ...
    def compact_bullet(paragraph) -> None:
        ...
        try:
            ...
            pass  # noqa: S110 - bullet format failure
    ...
    def center_paragraph(paragraph) -> None:
        ...
        try:
            ...
            pass  # noqa: S110 - center alignment failure
    ...
    def apply_shading(paragraph, bg_rgb: RGB) -> None:
        ...
        try:
            ...
            pass  # noqa: S110 - shading failure
    ...
    def apply_run_color(run, hex_color: Optional[str]) -> None:
        ...
        if rgb:
            try:
                ...
                pass  # noqa: S110 - color apply failure
    ...
    def apply_run_size(run, size_pt: Optional[float]) -> None:
        ...
        if size_pt:
            try:
                ...
                pass  # noqa: S110 - font size failure
